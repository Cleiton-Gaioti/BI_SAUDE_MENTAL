...
def extract_sim(state, start_year, end_year):
...
def run_sim(state, start_year, end_year, con, schema, tb_name):
    extract_sim(state, start_year, end_year).pipe(treat_sim).pipe(load_sim, con, schema, tb_name)
